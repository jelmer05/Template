...
var A = (o) => new Promise((e, t) => {
  ...
  s.async = true, s.src = o, s.id = "storyblok-javascript-bridge", s.onerror = (r) => t(r), s.onload = (r) => {
    b.forEach((i) => i()), v = true, e(r);
  }, document.getElementsByTagName("head")[0].appendChild(s);
});
var I = Object.defineProperty;
var M = (o, e, t) => e in o ? I(o, e, { enumerable: true, configurable: true, writable: true, value: t }) : o[e] = t;
var h = (o, e, t) => (M(o, typeof e != "symbol" ? e + "" : e, t), t);
function w(o) {
...
var ne = class {
  constructor(e, t) {
    if (h(this, "client"), h(this, "maxRetries"), h(this, "throttle"), h(this, "accessToken"), h(this, "cache"), h(this, "helpers"), h(this, "relations"), h(this, "links"), h(this, "richTextResolver"), h(this, "resolveNestedRelations"), !t) {
      const i = e.region ? `-${e.region}` : "", n = e.https === false ? "http" : "https";
  ...
  async resolveLinks(e, t) {
    ...
    if (e.link_uuids) {
      ...
      s = e.links;
    s.forEach((r) => {
      this.links[r.uuid] = { ...r, _stopResolving: true };
    });
  }
  async resolveRelations(e, t) {
    ...
    s && s.length > 0 && s.forEach((r) => {
      this.relations[r.uuid] = { ...r, _stopResolving: true };
    });
  }
...
var k;
var le = "https://app.storyblok.com/f/storyblok-v2-latest.js";
var ce = (o, e, t = {}) => {
  var s;
...
var he = (o = {}) => {
  ...
  return s !== false && u && A(le), k = new m(a.schema), a.resolver && T(k, a.resolver), c;
};
var T = (o, e) => {
  o.addNode("blok", (t) => {
    let s = "";
